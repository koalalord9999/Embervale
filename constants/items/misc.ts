...
export const misc: Item[] = [
    ...
    { id: 'glimmerhorn_dust', name: 'Glimmerhorn Dust', description: 'The ground-up horn of a mystical beast.', stackable: false, value: 30, iconUrl: 'https://api.iconify.design/game-icons:powder.svg' },
    ...
    { id: 'wyrmscale_dust', name: 'Wyrmscale Dust', description: 'Dust from a wyrm\'s scale. It feels warm.', stackable: false, value: 150, iconUrl: 'https://api.iconify.design/game-icons:scales.svg' },
