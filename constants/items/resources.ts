...
export const resources: Item[] = [
    ...
    { id: 'crystalline_shell_shard', name: 'Crystalline Shell Shard', description: "A shard from a Crystalline Tortoise. It's surprisingly light and sharp.", stackable: false, value: 120, iconUrl: 'https://api.iconify.design/game-icons:crystal-shard.svg', material: 'steel' },
