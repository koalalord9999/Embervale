...
export const foodAndPotions: Item[] = [
    ...
    { id: 'cooked_anchovy', name: 'Cooked Anchovy', description: 'A small cooked fish. Tasty on pizza.', stackable: false, value: 15, iconUrl: 'https://api.iconify.design/game-icons:shrimp.svg', consumable: { healAmount: 3 }, material: 'uncut-sapphire' },
