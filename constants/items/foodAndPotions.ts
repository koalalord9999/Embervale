...
export const foodAndPotions: Item[] = [
    ...
    { id: 'raw_tuna', name: 'Raw Tuna', description: 'A large, powerful fish.', stackable: false, value: 75, iconUrl: 'https://api.iconify.design/game-icons:fish-cooked.svg', material: 'raw-fish' },
    ...
    { id: 'cooked_trout', name: 'Cooked Trout', description: 'A nicely cooked trout. Heals a moderate amount of health.', stackable: false, value: 28, iconUrl: 'https://api.iconify.design/game-icons:fried-fish.svg', consumable: { healAmount: 7 }, material: 'cooked-fish' },
    { id: 'cooked_pike', name: 'Cooked Pike', description: 'A well-cooked pike. Heals a good amount of health.', stackable: false, value: 48, iconUrl: 'https://api.iconify.design/game-icons:fried-fish.svg', consumable: { healAmount: 8 }, material: 'cooked-fish' },
