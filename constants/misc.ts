...
export const misc: Item[] = [
    ...
    // Pouches
    { id: 'grimy_coin_pouch', name: 'Grimy Coin Pouch', description: "A small, dirty pouch that jingles slightly. It's too grimy to open by hand.", stackable: false, value: 50, iconUrl: 'https://api.iconify.design/game-icons:money-stack.svg', consumable: { givesCoins: { min: 20, max: 150 } } },
    ...
    { id: 'arrow_shaft', name: 'Arrow Shaft', description: 'A straight, headless arrow shaft.', stackable: true, value: 1, iconUrl: 'https://api.iconify.design/mdi:arrow-top-left.svg' },
    { id: 'headless_arrow', name: 'Headless Arrow', description: 'An arrow shaft with feathers attached. It just needs a tip.', stackable: true, value: 1, iconUrl: 'https://api.iconify.design/game-icons:arrow-flights.svg' },
    { id: 'bronze_arrowtips', name: 'Bronze Arrowtips', description: 'A set of 15 bronze arrowtips.', stackable: true, value: 10, iconUrl: 'https://api.iconify.design/game-icons:arrowhead.svg', material: 'bronze' },
    { id: 'iron_arrowtips', name: 'Iron Arrowtips', description: 'A set of 15 iron arrowtips.', stackable: true, value: 30, iconUrl: 'https://api.iconify.design/game-icons:arrowhead.svg', material: 'iron' },
    { id: 'steel_arrowtips', name: 'Steel Arrowtips', description: 'A set of 15 steel arrowtips.', stackable: true, value: 80, iconUrl: 'https://api.iconify.design/game-icons:arrowhead.svg', material: 'steel' },
    { id: 'mithril_arrowtips', name: 'Mithril Arrowtips', description: 'A set of 15 mithril arrowtips.', stackable: true, value: 150, iconUrl: 'https://api.iconify.design/game-icons:arrowhead.svg', material: 'mithril' },
    { id: 'adamantite_arrowtips', name: 'Adamantite Arrowtips', description: 'A set of 15 adamantite arrowtips.', stackable: true, value: 250, iconUrl: 'https://api.iconify.design/game-icons:arrowhead.svg', material: 'adamantite' },
    { id: 'runic_arrowtips', name: 'Runic Arrowtips', description: 'A set of 15 runic arrowtips.', stackable: true, value: 400, iconUrl: 'https://api.iconify.design/game-icons:arrowhead.svg', material: 'runic' },
    { id: 'shortbow_u', name: 'Shortbow (u)', description: 'An unstrung shortbow. It needs a bow string.', stackable: false, value: 15, iconUrl: 'https://api.iconify.design/game-icons:bow-arrow.svg' },
    { id: 'longbow_u', name: 'Longbow (u)', description: 'An unstrung longbow. It needs a bow string.', stackable: false, value: 20, iconUrl: 'https://api.iconify.design/game-icons:long-bow.svg' },
    { id: 'oak_shortbow_u', name: 'Oak Shortbow (u)', description: 'An unstrung oak shortbow.', stackable: false, value: 30, iconUrl: 'https://api.iconify.design/game-icons:bow-arrow.svg' },
    { id: 'oak_longbow_u', name: 'Oak Longbow (u)', description: 'An unstrung oak longbow.', stackable: false, value: 40, iconUrl: 'https://api.iconify.design/game-icons:long-bow.svg' },
    { id: 'willow_shortbow_u', name: 'Willow Shortbow (u)', description: 'An unstrung willow shortbow.', stackable: false, value: 60, iconUrl: 'https://api.iconify.design/game-icons:bow-arrow.svg' },
    { id: 'willow_longbow_u', name: 'Willow Longbow (u)', description: 'An unstrung willow longbow.', stackable: false, value: 80, iconUrl: 'https://api.iconify.design/game-icons:long-bow.svg' },
    { id: 'feywood_shortbow_u', name: 'Feywood Shortbow (u)', description: 'An unstrung shortbow made from magical feywood.', stackable: false, value: 100, iconUrl: 'https://api.iconify.design/game-icons:bow-arrow.svg' },
    { id: 'feywood_longbow_u', name: 'Feywood Longbow (u)', description: 'An unstrung longbow made from magical feywood.', stackable: false, value: 120, iconUrl: 'https://api.iconify.design/game-icons:long-bow.svg' },
    { id: 'yew_shortbow_u', name: 'Yew Shortbow (u)', description: 'An unstrung yew shortbow.', stackable: false, value: 150, iconUrl: 'https://api.iconify.design/game-icons:bow-arrow.svg' },
    { id: 'yew_longbow_u', name: 'Yew Longbow (u)', description: 'An unstrung yew longbow.', stackable: false, value: 200, iconUrl: 'https://api.iconify.design/game-icons:long-bow.svg' },

    // Herblore Items
    { id: 'pouch_cleanser', name: 'Pouch Cleanser', description: 'A special herbal concoction that can clean the grime off certain items. Requires Herblore to use effectively.', stackable: true, value: 20, iconUrl: 'https://api.iconify.design/game-icons:potion-ball.svg' },
    ...
    { id: 'unicorn_horn_dust', name: 'Unicorn Horn Dust', description: 'The ground-up horn of a unicorn. It has potent anti-poison properties.', stackable: true, value: 250, iconUrl: 'https://api.iconify.design/game-icons:powder.svg' },
];