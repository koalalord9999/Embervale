...
export const humanoids: Monster[] = [
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'runic_bar', chance: "1/50", minQuantity: 1, maxQuantity: 1, noted: true },
        ],
    ...
    },
    {
        ...
        iconUrl: 'https://api.iconify.design/game-icons:desert-helmet.svg',
        guaranteedDrops: [{ itemId: 'bones', minQuantity: 1, maxQuantity: 1 }],
        mainDrops: [
            { itemId: 'coins', chance: "1/1", minQuantity: 40, maxQuantity: 80 },
            { itemId: 'waterskin_full', chance: "1/8", minQuantity: 1, maxQuantity: 1 },
            { itemId: 'steel_scimitar', chance: "1/128", minQuantity: 1, maxQuantity: 1 },
        ],
