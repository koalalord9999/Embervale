...
export const wyrmwoodMonsters: Monster[] = [
    // --- Southern Branch (Lvl 55-70, Stealthy/Enchanted, Fearful) ---
    {
        ...
        iconUrl: 'https://api.iconify.design/game-icons:lynx-head.svg',
    ...
    },
    {
        ...
        iconUrl: 'https://api.iconify.design/game-icons:dryad.svg',
    ...
    },
    {
        ...
        iconUrl: 'https://api.iconify.design/game-icons:thorny-tentacle.svg',
    ...
    },
    {
        ...
        iconUrl: 'https://api.iconify.design/game-icons:forest-beast.svg',
    ...
    },
    {
        ...
        types: [MonsterType.Beast], attackSpeed: 3, respawnTime: 40000, aggressive: true, attackStyle: 'slash', customMaxHit: 14,
        poisonsOnHit: { chance: 0.2, damage: 3 },
        mainDrops: [{ itemId: 'wolf_pelt', chance: '1/1' }, { itemId: 'mithril_bar', chance: '1/32', noted: true }],
        guaranteedDrops: [{ itemId: 'big_bones', minQuantity: 1, maxQuantity: 1 }],
    },
    {
        id: 'feral_dragonling', name: 'Feral Dragonling', level: 88, maxHp: 100, attack: 85, strength: 82, defence: 80,
        stabDefence: 80, slashDefence: 85, crushDefence: 75, rangedDefence: 78, magicDefence: 70,
        ...
        mainDrops: [{ itemId: 'dragon_bones', chance: '1/2' }, { itemId: 'grove_hide', chance: '1/4' }],
        guaranteedDrops: [{ itemId: 'bones', minQuantity: 1, maxQuantity: 1 }],
    },
    {
    ...
    },
    {
        ...
        iconUrl: 'https://api.iconify.design/game-icons:horned-reptile.svg',
