...
export const resources: Item[] = [
    ...
    // Logs
    { id: 'logs', name: 'Logs', description: 'Standard logs from a tree.', stackable: false, value: 2, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    { id: 'oak_logs', name: 'Oak Logs', description: 'Sturdy logs from a mighty oak tree.', stackable: false, value: 15, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    { id: 'willow_logs', name: 'Willow Logs', description: 'Flexible logs from a willow tree.', stackable: false, value: 40, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    { id: 'feywood_logs', name: 'Feywood Logs', description: 'Logs from a Feywood tree. They shimmer with a faint, magical light.', stackable: false, value: 80, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    { id: 'yew_logs', name: 'Yew Logs', description: 'Logs from an ancient yew tree, perfect for powerful bows.', stackable: false, value: 120, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    { id: 'driftwood_logs', name: 'Driftwood Logs', description: 'Weathered logs, hardened by the sea.', stackable: false, value: 5, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    { id: 'mahogany_logs', name: 'Mahogany Logs', description: 'Rich, dark red logs from a tropical tree.', stackable: false, value: 150, iconUrl: 'https://api.iconify.design/game-icons:wood-pile.svg' },
    ...
    { id: 'feathers', name: 'Feathers', description: 'A handful of light feathers.', stackable: true, value: 1, iconUrl: 'https://api.iconify.design/game-icons:feather.svg' },
    ...
    { id: 'harpy_feather', name: 'Harpy Feather', description: 'A large, sharp feather from a harpy. Could be used in fletching.', stackable: false, value: 50, iconUrl: 'https://api.iconify.design/game-icons:feather.svg', material: 'uncut-sapphire' },
    ...
    { id: 'fey_dust', name: 'Fey Dust', description: 'A pinch of glittering, magical dust with a faint lavender scent.', stackable: true, value: 75, iconUrl: 'https://api.iconify.design/game-icons:glitter.svg' },
    { id: 'serpent_scale_dust', name: 'Serpent Scale Dust', description: 'Fine, iridescent dust ground from the scales of a powerful swamp serpent.', stackable: true, value: 150, iconUrl: 'https://api.iconify.design/game-icons:scales.svg' },
