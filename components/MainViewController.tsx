...
import CraftingProgressView from './CraftingProgressView';
import CombatView from './CombatView';
import QuestDialogueView from './QuestDialogueView';
import InteractiveDialogueView from './InteractiveDialogueView';
import NpcDialogueView from './NpcDialogueView';
import BankView from './BankView';
import ShopView from './ShopView';
import SmithingView from './SmithingView';
import CookingView from './CookingView';
import CraftingView from './CraftingView';
import SpinningView from './SpinningView';
import GemCuttingView from './GemCuttingView';
import FletchingView from './FletchingView';
import QuestBoardView from './QuestBoardView';
import SceneView from './SceneView';
import QuestDetailView from './QuestDetailView';
import TeleportView from './TeleportView';
...
const MainViewController: React.FC<MainViewControllerProps> = (props) => {
    ...
    if (ui.combatQueue.length > 0) {
        return <CombatView 
            ...
            onKill={handleKill} 
            // FIX: Pass the `activeBuffs` state to the `CombatView` to allow it to apply buff effects during combat.
