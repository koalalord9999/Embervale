...
const Hud: React.FC<HudProps> = ({ skills, currentHp, maxHp, combatLevel, activePanel, setActivePanel, onResetGame, onExportGame, onImportGame, onOpenAtlas, isBusy, setContextMenu, onOpenExpandedMap, onToggleDevPanel }) => {
    return (
