...
// FIX: Pass the char object combined with the setCombatStance function to satisfy the component's prop types.
char: {...char, setCombatStance},
// FIX: Pass the itemActions object to satisfy the component's prop types.
