...
export const oakhavenPois: Record<string, POI> = {
        ...
        activities: [
            {
                ...
                dialogue: ["Be careful on the King's Road. We've had patrols go missing. Word is the bridge to the west is out."]
            },
            { type: 'quest_start', questId: 'capitals_call' }
        ],
        regionId: 'wilderness',
        x: 950, y: 1800,
    ...
    oakhaven_crafting_district: {
        ...
        connections: ['oakhaven_square', 'oakhaven_crafting_supplies', 'tanner_svens_shop', 'oakhaven_west_gate'],
        activities: [],
        regionId: 'oakhaven',
        x: 190, y: 160,
        type: 'internal',
        ...
        activities: [
            {
                ...
                dialogue: [
                    "Need some hides tanned? You've come to the right place.",
                    "I can turn a tough cowhide into a piece of workable leather for a small fee."
                ]
            }
        ],
        regionId: 'oakhaven',
    ...
    the_carved_mug: {
        ...
        activities: [
            ...
            { type: 'cooking_range' },
            {
                ...
                dialogue: [
                    "Welcome to The Carved Mug! Come in, warm yourself by the fire.",
            ...
            },
            {
                ...
                dialogue: [
                    "Hah! Seen a few things in my day, I have. Fought goblins that were bigger than a cow and twice as mean.",
    ...
    oakhaven_bank: {
        ...
        activities: [
            { type: 'bank' },
            {
                ...
                dialogue: ["Bank of Embervale, Oakhaven branch. How may I assist you?"]
            }
        ],
        regionId: 'oakhaven',
        x: 190, y: 220,
