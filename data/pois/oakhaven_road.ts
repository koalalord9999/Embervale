...
export const oakhavenRoadPois: Record<string, POI> = {
    oakhaven_road_1: {
        ...
        connections: ['dusty_crossroads', 'oakhaven_road_2'],
        activities: [
    ...
    kings_road_west_1: {
        ...
        connections: ['oakhaven_west_gate', 'broken_bridge'],
        activities: [
    ...
    silverhaven_outskirts: {
        ...
        description: 'The road widens and becomes better maintained. In the distance, the tall walls and gleaming spires of a massive city are visible.',
        connections: ['kings_road_west_2', 'silverhaven_gates'],
        activities: [],
        regionId: 'wilderness',
        x: 700, y: 1800
    },
