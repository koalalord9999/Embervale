...
export const wyrmwoodGrovePois: Record<string, POI> = {
    ...
    wg_southern_path_1: { id: 'wg_southern_path_1', name: 'Southern Path', description: 'This path seems more traveled, likely a trade or patrol route.', connections: ['wyrmwood_grove_entrance', 'wg_travelers_shrine'], activities: [{ type: 'combat', monsterId: 'shadow_cat' }], regionId: 'wyrmwood_grove', x: 1730, y: 1510 },
    ...
    wg_northern_path_1: { id: 'wg_northern_path_1', name: 'Northern Path', description: 'This path leads deeper into the heart of the ancient grove.', connections: ['wyrmwood_grove_entrance', 'wg_ancient_grove'], activities: [{ type: 'combat', monsterId: 'corrupted_treant' }], regionId: 'wyrmwood_grove', x: 1730, y: 1490 },
    wg_ancient_grove: { id: 'wg_ancient_grove', name: 'Ancient Grove', description: 'The trees here are massive and ancient. A profound silence fills the air.', connections: ['wg_northern_path_1', 'wg_deepwood_crossroads'], activities: [{ type: 'combat', monsterId: 'raging_bear' }], regionId: 'wyrmwood_grove', x: 1760, y: 1485 },
    ...
    wg_whispering_stream_1: { id: 'wg_whispering_stream_1', name: 'Whispering Stream', description: 'A clear stream flows north. The sound of the water sounds like faint whispers.', connections: ['wg_deepwood_crossroads', 'wg_whispering_stream_2'], activities: [], regionId: 'wyrmwood_grove', x: 1785, y: 1420 },
